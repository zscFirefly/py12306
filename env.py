...
USER_ACCOUNTS = [
    # 目前已支持仅查询，不下单，屏蔽掉下面的账号即可
    {
        ...
        'user_name': '13670460933',
        'password': 'chsygjzx10733',
...
OUT_PUT_LOG_TO_FILE_PATH = '/Users/zhengshuocong/Desktop/dev/py12306/config/12306.log'  # 日志目录
RUNTIME_DIR = '/Users/zhengshuocong/Desktop/dev/py12306/data/'
QUERY_DATA_DIR = '/Users/zhengshuocong/Desktop/dev/py12306/data/query/'
USER_DATA_DIR = '/Users/zhengshuocong/Desktop/dev/py12306/data/user/'
...
QUERY_JOBS = [
    {
        'job_name':  'sz -> st',  # 任务名称，不填默认会以车站名命名，不可重复
    ...
    {
        'job_name':  'sz -> cs',  # 任务名称，不填默认会以车站名命名，不可重复
        'account_key': 0,  # 将会使用指定账号下单
        'left_dates': [  # 出发日期 :Array
            "2024-02-05",
            "2024-02-05",
